...
| [Quality Pipeline](./quality-pipeline.md) | 5-stage verification: veracity (regex + LLM + filesystem cross-check), tool policy with approval gate, quality gates, AI reviewer |
...
| Document | Description |
|----------|-------------|
| [Plugins](./plugins.md) | All 12 plugins across 8 slots, configuration examples, custom plugin authoring guide |

## Quick Links

- [CLI Commands](./getting-started.md#spawn-your-first-agent) — 17 commands: init, spawn, start, stop, send, status, kill, batch-spawn, watch, logs, dashboard, monitor, approvals, approve, deny, cleanup, doctor
...
- [Plugin Slots](./plugins.md#plugin-slots) — runtime, agent, workspace, tracker, scm, notifier, reviewer, terminal
