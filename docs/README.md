...
- [CLI Commands](./getting-started.md#spawn-your-first-agent) — 14 commands: init, spawn, start, stop, send, status, kill, batch-spawn, watch, logs, dashboard, monitor, cleanup, doctor
